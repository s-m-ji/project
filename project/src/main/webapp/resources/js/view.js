			  	...
			  	photoReview.forEach(function(item, index){
			  		...
			  		if(index == index1){
			  			...
			  			photoBtn +=
			  				...
			  				'<div class="carousel-item active photoBtn" data-bs-interval="10000">'
		  					+	'<img style="height: 400px;" src="/display?fileName=' + savePath + '" class="d-block photoBtn" data-rno="'+item.r_no+'" alt="...">'			  				
		  					+ '</div>';
			  			...
			  			photoBtn +=
			  				...
			  				'<div  class="carousel-item photoBtn">'
					    	+		'<img style="height: 400px;" src="/display?fileName=' + sPath + '" class="d-block photoBtn" data-rno="'+item.r_no+'" alt="...">'						   
					    	+    '</div>';
